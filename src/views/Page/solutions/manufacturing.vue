  ...
  <div class="page">
    <div class="page-banner" id="banner">
      <div class="banner-content">
        <div class="banner-title">智能制造</div>
        <div class="banner-text">
          结构化的数据处理服务，全面提高生产效能和安全性
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      annotationData: [
        {
          url: require('../../../assets/images/card/data/解决方案/智能制造/1.png'),
          title: '生产线质检',
          desc: '对生产线产品检测画框，辅助质量检测。',
          tag: ['智能客服', '新零售', '安全防护'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/智能制造/2.png'),
          title: '汽车损坏部位检测',
          desc: '标注汽车损坏部位，辅助工业定损。',
          tag: ['自动驾驶', '安全防护'],
        },
      ],
...
.page {
  ...
  .page-banner {
    width: 100%;
    background-image: url('../../../assets/images/banner/solutins/3.jpg');
    position: relative;
    height: 1080px;
    width: 100%;
