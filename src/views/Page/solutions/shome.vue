  ...
  <div class="page">
    <div class="page-banner" id="banner">
      <div class="banner-content">
        <div class="banner-title">智能家居</div>
        <div class="banner-text">
          家居场景实地采集识别，助力人机交互体验再升级
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      annotationData: [
        {
          url: require('../../../assets/images/card/data/解决方案/智能家居/1.png'),
          title: '场景识别',
          desc: '家居的不同使用场景识别，自启动个性化模式。',
          tag: ['智能客服', '新零售', '安全防护'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/智能家居/2.png'),
          title: '语音识别',
          desc: '智能家电设备语音识别，让人机交互体验更自然。',
          tag: ['自动驾驶', '安全防护'],
        },
      ],
...
.page {
  ...
  .page-banner {
    width: 100%;
    background-image: url('../../../assets/images/banner/solutins/4.jpg');
    position: relative;
    height: 1080px;
    width: 100%;
