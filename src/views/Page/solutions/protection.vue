  ...
  <div class="page">
    <div class="page-banner" id="banner">
      <div class="banner-content">
        <div class="banner-title">安全防护</div>
        <div class="banner-text">
          覆盖全场景的音视频标记采集，推进安防智能化发展
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      annotationData: [
        {
          url: require('../../../assets/images/card/data/解决方案/安全防护/1.png'),
          title: '人脸识别',
          desc: '门禁系统人脸矩形框识别认证。',
          tag: ['智能客服', '新零售', '安全防护'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/安全防护/2.png'),
          title: '文字识别',
          desc: '智慧城市车牌号码/敏感字符识别。',
          tag: ['自动驾驶', '安全防护'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/安全防护/3.png'),
          title: '行人实时跟踪',
          desc: '监控图像视频行人识别。',
          tag: ['文字转录', '内容分析', '情绪分析'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/安全防护/4.png'),
          title: '车辆画框标注',
          desc: '车辆实时追踪及自动驾驶类应用。',
          tag: [],
        },
...
.page {
  ...
  .page-banner {
    width: 100%;
    background-image: url('../../../assets/images/banner/solutins/5.jpg');
    position: relative;
    height: 1080px;
    width: 100%;
