  ...
  <div class="page">
    <div class="page-banner" id="banner">
      <div class="banner-content">
        <div class="banner-title">自动驾驶</div>
        <div class="banner-text">
          提供全面个性化的标注服务，让出行更安全更省时
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      annotationData: [
        {
          url: require('../../../assets/images/card/data/解决方案/自动驾驶/1.png'),
          title: '3D车辆标注',
          desc: '标注采集同向道路内部行驶的车辆和道路轮廓。',
          tag: ['智能客服', '新零售', '安全防护'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/自动驾驶/2.png'),
          title: '可行驶区域标注',
          desc: '对行驶方向及道路可行驶区域进行标注。',
          tag: ['自动驾驶', '安全防护'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/自动驾驶/3.png'),
          title: '图像语义分割',
          desc: '像素级精细标注，同类物体分色块标注。',
          tag: ['文字转录', '内容分析', '情绪分析'],
        },
        {
          url: require('../../../assets/images/card/data/解决方案/自动驾驶/4.png'),
          title: '检测框',
          desc: '行人车辆检测框属性标注。',
          tag: [],
        },
...
.page {
  ...
  .page-banner {
    width: 100%;
    background-image: url('../../../assets/images/banner/solutins/1.jpg');
    position: relative;
    height: 1080px;
    width: 100%;
